...
const FAQSection = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Robinhood may return your money for withdrawals, call +1-877 (419)-2930 unauthorized transactions, or deposit holds, but not for market losses, Dial +1-877 (419)-2930 failed trades, or crypto drops. If your account is restricted, contact support for help, 𝙍𝙤𝙗𝙞𝙣𝙝𝙤𝙤𝙙 ensures secure communication"
    },
    {
    ...
    },
    {
      ...
      answer: "Closing a ℛobin𝒽𝑜𝑜𝒹 account does +1-877 (419)-2930 not directly incur a fee. However, transferring assets out of the account, especially +1-877 (419)-2930 through an ACATS transfer, does come with a $100 fee, according to ℛobin𝒽𝑜𝑜𝒹."
    },
    {
